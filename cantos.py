...
class ProyectorCantos:
    ...
    def actualizar_orden_seleccion(self, event):
        ...
        for index in seleccion:
            if index not in self.orden_seleccion:
                self.orden_seleccion.append(index)
        self.orden_seleccion = [i for i in self.orden_seleccion if i in seleccion]
    ...
    def cargar_setlist(self):
        ...
        self.setlist = [self.canciones[i] for i in self.orden_seleccion]
        self.cancion_actual_index = 0
